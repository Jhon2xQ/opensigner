---
title: Recovering a Key
description: Before recovering a key, the user must call hot storage to retrieve their list of accounts and select the one to recover.
---
